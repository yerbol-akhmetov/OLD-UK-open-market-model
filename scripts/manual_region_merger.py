...
def main():
    ...
    merge_groups = [
        [55, 56],                                    # Join 55 and 56
        [47, 48, 49],                               # Join 47, 48, 49
        [52, 53],                                   # Join 52 and 53
        [40, 44, 45],                               # Join 40, 44, and 45
        [18, 19, 20, 21, 22, 23, 24, 31, 32, 33, 34, 94, 95],  # Join 18, 19, 20, 21, 22, 23, 24, 31, 32, 33, 34, 94, 95
        [25, 26, 27, 35, 36, 37],                   # Join 25, 26, 27, 35, 36, 37
        [13, 14, 15, 28, 29, 30],                   # Join 13, 14, 15, 28, 29, 30
        [3, 91],                                    # Join 3, 91
        [2, 92]                                     # Join 2, 92
    ]
